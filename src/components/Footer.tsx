        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-14">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
              Redefining the dental experience through luxury, technology,
              and clinical excellence in Mumbai. Experience premium boutique
          ...
          <div className="space-y-6">
            ...
            {/* PREMIUM MAP EFFECT */}
            <a
              href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d60335.959310745784!2d72.86668930721245!3d19.063849427164627!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c73d9deb1b17%3A0xcabc7277a44a4c94!2sUNIQUE%20DENTAL%20CARE!5e0!3m2!1sen!2sin!4v1780071388186!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative h-32 rounded-[24px] border border-white/10 bg-[#03231B] overflow-hidden flex items-center justify-center hover:border-amber-700 transition-all duration-500 shadow-[0_10px_40px_rgba(0,0,0,0.3)]"
            >
              {/* Luxury Emerald Glow */}
              <div className="absolute -top-12 right-0 w-40 h-40 bg-amber-500/10 rounded-full blur-[80px]" />
              ...
              <svg
                className="absolute inset-0 w-full h-full text-emerald-700/30"
              ...
              {/* LOCATION LABEL */}
              <div className="z-10 bg-[#03231B]/90 backdrop-blur-xl px-4 py-2 rounded-full border border-white/10 flex items-center gap-2 group-hover:scale-105 transition-transform duration-300">
